...
Config.AntiSpam = 2000							-- ระยะเวลาป้องการการ Spam กดปุ่มใช้ Item (1000 = 1 วินาที)
...
Config.HUD = {
	...
	logo = {
		...
		off_scale = 1.0,						-- ขนาด Logo ขณะ "ปิด" กระเป๋า
		on_scale = 1.2,							-- ขนาด Logo ขณะ "เปิด" กระเป๋า
	...
	shortcuts = 6,								-- จำนวน Shortcut ที่ต้องการ [0-9]
...
Config.Keys = {
	...
	default = {								-- ปุ่มแบบ FiveM Default
		open = 289,							-- ปุ่ม เปิด กระเป๋าส่วนตัว (ปุ่มปิดกระเป๋าจะเป็น Esc ไม่สามารถแก้ไขได้)
	...
	keybindings = {
		open = 'F2',						-- ปุ่ม เปิด กระเป๋าส่วนตัว (ปุ่มปิดกระเป๋าจะเป็น Esc ไม่สามารถแก้ไขได้)
